...
const SleeveComponent = () => {
  return (
    <div className={`text-center py-16 ${sharedClasses.bgWhite} ${sharedClasses.bgDark}`}>
      ...
      <p className={`mt-2 text-lg ${sharedClasses.textZinc400}`}>Sleeve sits on the desktop, displaying and controlling the music you’re currently playing in <span className={sharedClasses.textRed500}> Apple Music</span>, <span className={sharedClasses.textGreen500}>Spotify</span>, and <span className={sharedClasses.textBlue500}>Doppler</span>.</p>
